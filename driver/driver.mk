...
export SHUN_FILES = interrupt.c
SHUN_PATHS = $(addprefix $(DRIVER_DIR)/,$(SHUN_FILES))
...
export SHUN_IRQ_MODULE_NAME = shunirq
SHUNIRQ_OBJECT = $(DRIVER_DIR)/$(SHUN_IRQ_MODULE_NAME).ko
SHUNIRQ_OUTPUT_OBJECT = $(OUTPUT_DIR)/$(SHUN_IRQ_MODULE_NAME).ko
...
shundriver: $(SHUNIRQ_OUTPUT_OBJECT)
...
$(SHUNIRQ_OBJECT): $(SHUN_PATHS) $(KERNEL_SYMS) | kbuild_def_check \
			arch_def_check kbuild_exists_check kbuild_built_check \
			cross_compiler_check
	make -C $(KBUILD_DIR) M=$(PWD)/$(DRIVER_DIR) modules
